...
//                            finish();
        ...
        String orderInfo = getOrderInfo("尚硅谷商城购物", "买了好多东西", adapter.getTotalPrice()+"");
